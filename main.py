...
def errorWindow(
    ...
    **kwargs,
    ...
    errorConfirmButton = ttk.Button(
        errorWindow, text="OK", command=lambda: errorWindow.destroy()
    )
...
def messageWindow(
    ...
    **kwargs,
    ...
    messageConfirmButton = ttk.Button(
        messageWindow, text="OK", command=lambda: messageWindow.destroy()
    )
...
icon_photo = tk.PhotoImage(file="happyday.png")
...
selectHRTFFileButton = ttk.Button(
    hrtfFrame, text="Select HRTF File (.wav)", command=lambda: selectHRTFFile()
)
...
selectSourceFileButton = ttk.Button(
    sourceFrame, text="Select source file (.wav)", command=lambda: selectSourceFile()
)
...
selectSOFAFileButton = ttk.Button(
    bottomSectionFrame, text="Select SOFA File", command=lambda: selectSOFAFile()
)
...
quitButton = ttk.Button(rootFrame, text="Quit", command=lambda: sys.exit())
